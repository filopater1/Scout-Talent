  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="border-b bg-white">
        <div className="max-w-full px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-600">Sarah Chen (Recruiter)</span>
      ...
      <div className="max-w-full px-6 py-8">
        {/* Welcome & KPIs */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Recruitment Pipeline</h1>
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-6">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-xs text-gray-500 mt-1">-3 days vs last month</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-xs text-gray-500 mt-1">75% acceptance rate</p>
              </CardContent>
            </Card>
          </div>
...
function KanbanColumn({ title, count, color, candidates, onCandidateClick }: KanbanColumnProps) {
  return (
            ...
            <CardContent className="p-4">
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs font-semibold text-indigo-600">{candidate.aiScore}%</span>
                </div>
